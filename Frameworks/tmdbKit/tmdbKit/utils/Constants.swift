...
public struct Constants {
    ...
    public enum Endpoint {
        ...
        public static func trendingMovies(page: Int) -> String { "/trending/movie/day?api_key=\(Constants.tmdbAPIKey)&page=\(page)" }
        ...
        public static func movieDetails(id: Int) -> String { "/movie/\(id)?api_key=\(Constants.tmdbAPIKey)" }
